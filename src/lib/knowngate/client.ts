...
export const knownGateClient = {
  checkItem: (body: CheckItemRequest) => request<ItemResult>("/api/knowngate/v0/check/item", { method: "POST", body: JSON.stringify(body) }),
  checkPlace: (body: CheckPlaceRequest) => request<PlaceResult>("/api/knowngate/v0/check/place", { method: "POST", body: JSON.stringify(body) }),
